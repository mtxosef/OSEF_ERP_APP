    ...
    public class CroquisOrdenEstimacionDDataAccess
    {
        ...
        public static int Insertar(CroquisOrdenEstimacionD iCroquisOrdenEstimacionD)
        {
            try
            {
                ...
                sqlpID.Value = iCroquisOrdenEstimacionD.ID;
            ...
            {
                throw new Exception("Error capa de datos (public static int Insertar(CroquisOrdenEstimacionD " + iCroquisOrdenEstimacionD.ID + ")): " + ex.Message);
            }
        }
