    ...
    public class ImagenOrdenEstimacionDDataAccess
    {
        ...
        public static int Insertar(ImagenOrdenEstimacionD iImagenOrdenEstimacionD)
        {
            try
            {
                ...
                sqlpID.Value = iImagenOrdenEstimacionD.ID;
            ...
            {
                throw new Exception("Error capa de datos (public static int Insertar(ImagenOrdenEstimacionD " + iImagenOrdenEstimacionD.ID + ")): " + ex.Message);
            }
        }
        ...
        public static int BorrarImagenesOrdenEstimacionDPorConcepto(int dID, string strIDConcepto)
        {
            try
            {
                ...
                sqlcComando.Connection = sqlcConectar;
                sqlcComando.CommandType = CommandType.StoredProcedure;
                sqlcComando.CommandText = "BorrarImagenOrdenEstimacionDPorConcepto";
        ...
        public static int BorrarImagenesOrdenesEstimacionPorID(int dID)
        {
            try
            {
                ...
                sqlcComando.Connection = sqlcConectar;
                sqlcComando.CommandType = CommandType.StoredProcedure;
                sqlcComando.CommandText = "BorrarImagenOrdenEstimacionDPorOrdenEstimacion";
