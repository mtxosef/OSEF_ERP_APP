...
-- Estados (Consultar)
:r c:\SqlServerScripts\Consultar\Estados\web_spS_ObtenerEstados.sql
:r c:\SqlServerScripts\Consultar\Estados\web_spS_ObtenerEstadoPorID.sql
-- Estados (Insertar)
...
:r c:\SqlServerScripts\Consultar\Municipios\web_spS_ObtenerMunicipios.sql
:r c:\SqlServerScripts\Consultar\Municipios\web_spS_ObtenerMunicipioPorID.sql
:r c:\SqlServerScripts\Consultar\Municipios\web_spS_ObtenerMunicipiosPorEstado.sql
-- Municipios (Insertar)
...
:r c:\SqlServerScripts\Consultar\Proveedores\web_spS_ObtenerProveedores.sql
:r c:\SqlServerScripts\Consultar\Proveedores\web_spS_ObtenerProveedorPorID.sql
-- Proveedores (Insertar)
:r c:\SqlServerScripts\Insertar\Proveedores\web_spI_InsertarProveedor.sql
-- Proveedores (Modificar)
:r c:\SqlServerScripts\Modificar\Proveedores\web_spU_ActualizarProveedor.sql
-----------------------------------------------------------------------------------
-- Revisiones (Borrar)
:r c:\SqlServerScripts\Borrar\Revisiones\web_spD_BorrarRevision.sql
...
:r c:\SqlServerScripts\Borrar\RevisionesD\web_spD_BorrarRevisionDPorRevision.sql
-- RevisionesD (Consultar)
:r c:\SqlServerScripts\Consultar\RevisionesD\web_spS_ObtenerRevisionesDPorRevision.sql
-- RevisionesD (Insertar)
...
-- SubCategorias (Consultar)
:r c:\SqlServerScripts\Consultar\SubCategorias\web_spS_ObtenerSubCategorias.sql
...
:r c:\SqlServerScripts\Modificar\SubCategorias\web_spU_ActualizarSubCategoria.sql
-----------------------------------------------------------------------------------
-- Sucursales (Borrar)
...
:r c:\SqlServerScripts\Modificar\Sucursales\web_spU_ActualizarSucursal.sql
-----------------------------------------------------------------------------------
-- Usuarios (Borrar)
:r c:\SqlServerScripts\Borrar\Usuarios\web_spD_BorrarUsuario.sql
-- Usuarios (Consultar)
...
:r c:\SqlServerScripts\Consultar\PreciariosGenerales\web_spS_ObtenerPreciariosGeneralesRepetidos.sql
...
:r c:\SqlServerScripts\Reportes\TableroReportes\web_spS_ObtenerConceptosRevisados.sql