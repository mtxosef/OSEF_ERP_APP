...
IF EXISTS (	SELECT name 
			FROM sysobjects
			WHERE  name = 'web_spS_ObtenerCodigosPostalesEnUsoPorID' AND
			TYPE = 'P')
	DROP PROCEDURE web_spS_ObtenerCodigosPostalesEnUsoPorID
GO
CREATE PROCEDURE web_spS_ObtenerCodigosPostalesEnUsoPorID
