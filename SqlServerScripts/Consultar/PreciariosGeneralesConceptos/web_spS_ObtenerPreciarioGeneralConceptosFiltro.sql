...
IF EXISTS (	SELECT name 
			FROM sysobjects
			WHERE  name = 'web_spS_ObtenerPreciarioGeneralConceptosFiltro' AND
			TYPE = 'P')
	DROP PROCEDURE web_spS_ObtenerPreciarioGeneralConceptosFiltro
GO
-- =============================================
...
-- =============================================
CREATE PROCEDURE web_spS_ObtenerPreciarioGeneralConceptosFiltro
