...
IF EXISTS (	SELECT name 
			FROM sysobjects
			WHERE  name = 'web_spD_BorrarImagenPorConceptoVolumetria' AND
			TYPE = 'P')
	DROP PROCEDURE web_spD_BorrarImagenPorConceptoVolumetria
GO
-- =============================================
...
-- =============================================
CREATE PROCEDURE web_spD_BorrarImagenPorConceptoVolumetria
