...
IF EXISTS (	SELECT name 
			FROM sysobjects
			WHERE  name = 'web_spD_BorrarImagenOrdenEstimacionDPorConcepto' AND
			TYPE = 'P')
	DROP PROCEDURE web_spD_BorrarImagenOrdenEstimacionDPorConcepto
GO
-- =============================================
...
-- =============================================
CREATE PROCEDURE web_spD_BorrarImagenOrdenEstimacionDPorConcepto
