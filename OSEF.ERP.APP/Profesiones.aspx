<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profesiones.aspx.cs" Inherits="OSEF.AVANCES.SUCURSALES.Profesiones" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/profesiones.js"></script>
</head>
<body>
    <form id="form1" runat="server">
        <ext:ResourceManager ID="rmProfesiones" runat="server" />
        ...
        <ext:GridPanel
            ...
            <TopBar>
                <ext:Toolbar ID="tbProfesiones" runat="server">
                    <Items>
                        <ext:ImageButton
                            ID="imgbtnNuevo"
                            runat="server"
                        ...
                        <ext:ToolbarSpacer ID="tbsProfesiones" runat="server" Width="500">
                        </ext:ToolbarSpacer>
                        <ext:ImageButton
                            ID="imgbtnActualizar"
                            runat="server"
                            ...
                            Width="50">
                            <Listeners>
                                <Click Handler="#{sProfesiones}.reload(); App.imgbtnEditar.setDisabled(true); App.imgbtnBorrar.setDisabled(true);" />
                            </Listeners>
                        </ext:ImageButton>
                        <ext:TextField 
                            ID="txtfBuscar"
            ...
            <Store>
                <ext:Store
                    ID="sProfesiones"
                    runat="server"
                    OnReadData="OnReadData_sProfesiones">
                    <Model>
                        <ext:Model ID="mProfesiones" runat="server">
                            <Fields>
                    ...
                    <Listeners>
                        <DataChanged Fn="sProfesiones_DataChanged" />
                    </Listeners>
                </ext:Store>
            </Store>
            <ColumnModel>
            ...
            <Plugins>
                <ext:CellEditing ID="ceProfesiones" runat="server" ClicksToEdit="2">
                    <Listeners>
                        <ValidateEdit Fn="ceProfesiones_ValidateEdit" Delay="1" />
                    </Listeners>
                </ext:CellEditing>
            </Plugins>
            <Listeners>
                <ItemClick Fn="gpProfesiones_ItemClick" />
            </Listeners>
            <SelectionModel>
