<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormaEspecialidad.aspx.cs" Inherits="OSEF.ERP.APP.FormaEspecialidad" %>
...
<body class=">
    ...
    <ext:FormPanel ID="fpEspecialidad" runat="server" Height="150" DefaultButton="imgbtnGuardar" Layout="HBoxLayout" MonitorResize="true">
        <Items>
            ...
            <BottomBar>
                <ext:StatusBar ID="sbEspecialidad" runat="server" Cls="x-colorToolbar" Text="Sin validar información" />
            </BottomBar>
    </ext:FormPanel>
    </form>
</body>
