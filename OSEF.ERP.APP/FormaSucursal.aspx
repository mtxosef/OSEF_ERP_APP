                            ...
                            <ext:TabPanel
                                ...
                                <Items>
                                    <ext:Panel
                                        ...
                                        <ext:FieldContainer ID="ContenedorID" runat="server" FieldLabel="ID" LabelWidth="120"
                                            ...
                                            <Items>
                                                <ext:TextField ID="txtfID" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="10" EnforceMaxLength="true" Disabled="true">
                                                </ext:TextField>
                                                <ext:NumberField ID="nfCR" runat="server" Width="200" MaxLength="4" AllowBlank="false"
                                                    EnforceMaxLength="true" MinValue="0" MaxValue="9999" AllowDecimals="false" Step="1"
                                                    StyleSpec="margin-right: 6px;" FieldLabel="CR" LabelWidth="30" AutoFocus="true">
                                                </ext:NumberField>
                                                <ext:TextField ID="txtfDireccionZona" runat="server" EmptyText="Dirección Zona" Width="200"
                                                    StyleSpec="margin-right: 6px;" MaxLength="50" EnforceMaxLength="true">
                                                    <Listeners>
                                        ...
                                        <ext:FieldContainer ID="ContenedorNombre" runat="server" FieldLabel="Nombre" AnchorHorizontal="100%"
                                            LabelWidth="120" Layout="ColumnLayout">
                                            <Items>
                                                <ext:TextField ID="txtfNombre" runat="server" Width="611" StyleSpec="margin-right: 6px;"
                                        ...
                                        <ext:FieldContainer ID="ContenedorGerente" runat="server" FieldLabel="Contacto" LabelWidth="120"
                                            AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:TextField ID="txtfGerenteBBVANombre" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                ...
                                                <ext:TextField ID="txtfGerenteBBVAAPaterno" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="50" EnforceMaxLength="true">
                                                    <Listeners>
                                                        <Blur Handler="App.txtfGerenteBBVAAPaterno.setValue(App.txtfGerenteBBVAAPaterno.getValue().toUpperCase());" />
                                                    </Listeners>
                                                </ext:TextField>
                                                <ext:TextField ID="txtfGerenteBBVAAMaterno" runat="server" Width="200" MaxLength="50"
                                        ...
                                        <ext:FieldContainer ID="ContenedorSuperficie" runat="server" FieldLabel="Superficie (m2)"
                                            LabelWidth="120" AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:NumberField ID="nfSuperficie" runat="server" Width="200" MaxLength="4" EnforceMaxLength="true"
                                                    MinValue="0" MaxValue="9999" AllowDecimals="false" Step="1">
                                                </ext:NumberField>
                                            </Items>
                                        </ext:FieldContainer>
                                        <ext:FieldContainer ID="FieldContainerCalles" runat="server" LabelWidth="120" FieldLabel="Calle"
                                            AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:TextField ID="txtfCalle" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="100" AllowBlank="false" EnforceMaxLength="true">
                                                    <Listeners>
                                        ...
                                        <ext:FieldContainer ID="FieldContainerNumInt" runat="server" LabelWidth="120" FieldLabel="N° Exterior"
                                            AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:TextField ID="txtfNoExterior" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="10" EnforceMaxLength="true">
                                                    <Listeners>
                                                        <Blur Handler="App.txtfNoExterior.setValue(App.txtfNoExterior.getValue().toUpperCase());" />
                                                    </Listeners>
                                                </ext:TextField>
                                                <ext:TextField ID="txtfNoInterior" FieldLabel="N° Interior" runat="server" Width="300"
                                                    MaxLength="10" EnforceMaxLength="true">
                                                    <Listeners>
                                        ...
                                        <ext:FieldContainer ID="FieldContainerCPCol" runat="server" LabelWidth="120" FieldLabel="Código Postal"
                                            ...
                                            <Items>
                                                <ext:TextField ID="txtfCodigoPostal" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                  ...
                                                  <ext:TextField ID="txtEstado" runat="server" Width="300" StyleSpec="margin-right: 6px;"
                                        ...
                                        <ext:FieldContainer ID="FieldContainer1" runat="server" LabelWidth="120" FieldLabel="Municipio"
                                            ...
                                            <Items>
                                                ...
                                                <%--<ext:ComboBox ID="cmbEstado" runat="server" Width="300" FieldLabel="Estado" StyleSpec="margin-right: 6px;"
                                                  ...
                                                  <ext:TextField ID="txtColonia" runat="server" Width="300" StyleSpec="margin-right: 6px;"
                                        ...
                                        <ext:FieldContainer ID="ContenedorFechas" runat="server" FieldLabel="Fecha Alta"
                                            LabelWidth="120" AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:DateField ID="dfFechaAlta" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    Disabled="true">
                                                    <PickerOptions Cls="my-date-picker" ID="pOFechaAlta" runat="server">
                                                    </PickerOptions>
                                                </ext:DateField>
                                                <ext:ComboBox ID="cmbEstatus" runat="server" Width="300" FieldLabel="Estatus" Disabled="true">
                                                    <Items>
                                    ...
                                    <ext:Panel ID="pContrato" runat="server" Title="P Ulises" BodyPadding="10" AutoScroll="true">
                                        ...
                                        <ext:FieldContainer ID="ContenedorContratista" runat="server" LabelWidth="120" FieldLabel="Contratista"
                                            AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:ComboBox ID="cmbProveedor" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    DisplayField="Nombre" ValueField="ID" Editable="false" AllowBlank="false">
                                                    <ListConfig Width="200" MaxHeight="195">
                                                    </ListConfig>
                                                    <Store>
                                        ...
                                        <ext:FieldContainer ID="ContenedorInicioObra" runat="server" FieldLabel="Inicio Obra"
                                            LabelWidth="120" AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:DateField ID="dfInicioObra" runat="server" Width="200" AllowBlank="false" StyleSpec="margin-right: 6px;">
                                                ...
                                                <ext:NumberField ID="txtDiasObra" runat="server" Width="100" EmptyText="Días" AllowBlank="false"
                                                    Disabled="false" Editable="false" StyleSpec="margin-right: 6px;" MaxLength="4"
                                                    EnforceMaxLength="true" MinValue="0" MaxValue="9999" AllowDecimals="false" Step="1">
                                                    <Listeners>
                                                        <Change Handler="sumarDias(this.getValue(),App.dfInicioObra.getValue());" />
                                                    </Listeners>
                                                </ext:NumberField>
                                                <ext:DateField ID="dfFinObra" runat="server" Disabled="true" FieldLabel="Fin Obra"
                                                    Width="300">
                                                </ext:DateField>
                                            </Items>
                                        </ext:FieldContainer>
                                        ...
                                        <ext:FieldContainer ID="ContenedorSemanas" runat="server" FieldLabel="Semanas Obra"
                                            LabelWidth="120" Layout="ColumnLayout">
                                            <Items>
                                                <ext:NumberField ID="nfSemanasObra" runat="server" Width="200" Editable="false" Enabled="false"
                                                    StyleSpec="margin-right: 6px;" MaxLength="4" EnforceMaxLength="true" MinValue="0"
                                                    Disabled="true" MaxValue="9999" AllowDecimals="false" Step="1">
                                                </ext:NumberField>
                                            </Items>
                                        </ext:FieldContainer>
                                        ...
                                        <ext:FieldContainer ID="ContenedorCordinador" runat="server" LabelWidth="120" FieldLabel="Coordinador"
                                            AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:TextField ID="txtfCoordinadorNombre" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="50" EnforceMaxLength="true">
                                                    <Listeners>
                                                        <Blur Handler="App.txtfCoordinadorNombre.setValue(App.txtfCoordinadorNombre.getValue().toUpperCase());" />
                                                    </Listeners>
                                                </ext:TextField>
                                                <ext:TextField ID="txtfCoordinadorAPaterno" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="50" EnforceMaxLength="true">
                                                    <Listeners>
                                                        <Blur Handler="App.txtfCoordinadorAPaterno.setValue(App.txtfCoordinadorAPaterno.getValue().toUpperCase());" />
                                                    </Listeners>
                                                </ext:TextField>
                                                <ext:TextField ID="txtfCoordinadorAMaterno" runat="server" Width="200" MaxLength="50"
                                                    EnforceMaxLength="true">
                                                    <Listeners>
                                        ...
                                        <ext:FieldContainer ID="ContenedorProvEnergia" runat="server" LabelWidth="120" FieldLabel="Proveedor Energía"
                                            AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:TextField ID="txtfProveedorEnergia" runat="server" Width="612" MaxLength="100"
                                                    EnforceMaxLength="true">
                                                    <Listeners>
                                        ...
                                        <ext:FieldContainer ID="ContenedorSupervisor" runat="server" LabelWidth="120" FieldLabel="Supervisor"
                                            AnchorHorizontal="100%" Layout="ColumnLayout">
                                            <Items>
                                                <ext:TextField ID="txtfSupervisorNombre" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="50" EnforceMaxLength="true">
                                                    <Listeners>
                                                        <Blur Handler="App.txtfSupervisorNombre.setValue(App.txtfSupervisorNombre.getValue().toUpperCase());" />
                                                    </Listeners>
                                                </ext:TextField>
                                                <ext:TextField ID="txtfSupervisorAPaterno" runat="server" Width="200" StyleSpec="margin-right: 6px;"
                                                    MaxLength="50" EnforceMaxLength="true">
                                                    <Listeners>
                                                        <Blur Handler="App.txtfSupervisorAPaterno.setValue(App.txtfSupervisorAPaterno.getValue().toUpperCase());" />
                                                    </Listeners>
                                                </ext:TextField>
                                                <ext:TextField ID="txtfSupervisorAMaterno" runat="server" Width="200" MaxLength="50"
                                                    EnforceMaxLength="true">
                                                    <Listeners>
