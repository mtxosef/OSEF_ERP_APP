<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormaConcepto2.aspx.cs" Inherits="OSEF.AVANCES.SUCURSALES.FormaConcepto2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Store
            ...
            runat="server">
            <Model>
                <ext:Model ID="mConcepto" runat="server" IDProperty="ID">
                    <Fields>
